...
🚀 **[Dev Portfolio V2 has arrived. Meet Devfolio, a modern portfolio + blog template built with GatsbyJS and TailwindCSS](https://github.com/)** 🚀
...
Looking for a blog template? Checkout [DevBlog](https://github.com/).
